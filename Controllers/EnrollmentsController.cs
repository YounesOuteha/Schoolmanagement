...
namespace schoolManagement.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.LecturerId = new SelectList(db.Lectures, "Id", "FirstName");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "EnrollmentID,Grade,CourseID,StudentID,LecturerId")] Enrollment enrollment)
        {
            ...
            ViewBag.LecturerId = new SelectList(db.Lectures, "Id", "FirstName", enrollment.LecturerId);
            return View(enrollment);
        }
        ...
        public async Task<JsonResult> AddStudent([Bind(Include = "CourseID,StudentID")] Enrollment enrollment) 
        {
            ...
            catch (Exception)
            {
                ...
                return Json(new { IsSuccess = false, Message = "Please contact Administrator" }, JsonRequestBehavior.AllowGet);
            }
        }
